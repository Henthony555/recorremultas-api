package br.com.ifpe.recorremultas.config;
...
import br.com.ifpe.recorremultas.seguranca.jwt.JwtAuthenticationEntryPoint;
import br.com.ifpe.recorremultas.seguranca.jwt.JwtTokenAuthenticationFilter;
...
public class SecurityConfig {
    ...
    public AuthenticationManager authenticationManager(HttpSecurity http, BCryptPasswordEncoder bCryptPasswordEncoder,
            UsuService userDetailService) throws Exception {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .anyRequest()
                .hasAnyAuthority(Usu.ROLE_CLIENTE, Usu.ROLE_EMPRESA, Usu.ROLE_CLIENTE)
                .and().addFilterBefore(
